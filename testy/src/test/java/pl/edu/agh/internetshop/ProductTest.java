...
public class ProductTest {
    ...
    @Test
    public void testProductPriceAfterDiscount() throws Exception{
        //given

        // when
        Product product = new Product(NAME, PRICE);
        product.setDiscountValue(BigDecimal.valueOf(0.5));

        // then
        assertBigDecimalCompareValue(product.getPriceAfterDiscount(), BigDecimal.valueOf(0.5));
    }
}