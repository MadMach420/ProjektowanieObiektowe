...
public class OrderTest {
	...
	private Order getOrderWithMockedProduct() {
		...
		return new Order(product1, product2);
	}
	...
	public void testGetProductThroughOrder() {
		...
		// when
		Product[] actualProduct = order.getProducts();
	...
	public void testGetPriceAfterDiscount() throws Exception {
		...
		Order order = getOrderWithCertainProductPrice(1000);
		order.setDiscountValue(BigDecimal.valueOf(0.5));

		// when
		BigDecimal actualPrice = order.getPriceAfterDiscount();
	...
	@Test
	public void testGetPriceAfterDiscountWithTaxes() throws Exception {
		// given
		BigDecimal expectedPrice = BigDecimal.valueOf(1.23);
		Order order = getOrderWithCertainProductPrice(2);
		order.setDiscountValue(BigDecimal.valueOf(0.5));

		// when
		BigDecimal actualPrice = order.getPriceAfterDiscountWithTaxes();
